...
(function () {
  ...
  const RESUME_VARIANTS = {
    ...
    fde: {
      ...
      work_bullets: {
        [KETCHUP]: [
          '<b>Took an LLM-powered regulatory compliance platform from zero to presales-ready</b> and ran presales demos directly with customers, advancing pilot agreements into the contract pipeline with <b>Tier-1 Singapore banks and a regional insurer</b>: end-to-end ownership of discovery, build, and rollout',
    ...
    fullstack: {
      ...
      summary: 'Full-stack engineer with 5+ years owning features end-to-end across frontend, backend, and infrastructure. Currently at <b>Ketchup AI</b>, I own the full architecture of an AI compliance platform, shipping a <b>Next.js / TypeScript PWA</b> from zero to presales-ready. At <b>ByteDance</b>, I built distributed backend services on <b>Node.js and Go</b> for <b>180,000+ users</b>, cutting latency over <b>50%</b> at <b>99.95% uptime</b>. At <b>Pixium Digital</b>, I led full-stack delivery in <b>Elixir, React, and PHP</b>, lifting dashboard performance <b>62.5%</b> and automating deploys <b>80%</b> with Terraform and Docker. MIT-certified in ML, pursuing a part-time BIT at NUS.',
      skills: [
      ...
      work_bullets: {
        [KETCHUP]: [
          '<b>Owned the full-stack architecture end-to-end</b> for an AI-powered regulatory compliance platform, shipping a <b>Next.js / TypeScript PWA</b> from zero to presales-ready; product quality advanced pilot agreements into the contract pipeline with Tier-1 Singapore banks and a regional insurer',
    ...
    'ai-platform': {
      ...
      work_bullets: {
        [KETCHUP]: [
          ...
          'Built <b>multi-region locale propagation to backend AI agents</b> (Singapore, Taiwan, Malaysia), plus <b>enterprise OAuth</b> (Microsoft, Google, LinkedIn, Apple with PKCE) for a platform that advanced pilot agreements into the contract pipeline with <b>Tier-1 Singapore banks and a regional insurer</b>',
          'Owned end-to-end delivery of a <b>Next.js PWA from zero to presales-ready</b>, including offline support via a custom Service Worker strategy',
        ],
        [BYTEDANCE]: [
    ...
    'fintech-regtech': {
      ...
      work_bullets: {
        [KETCHUP]: [
          ...
          '<b>Owned all frontend architecture and delivery</b>, shipping a <b>Next.js PWA</b> from zero to presales-ready. Product quality advanced pilot agreements into the contract pipeline with <b>Tier-1 Singapore banks and a regional insurer</b>',
