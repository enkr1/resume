const RESUME_DATA = {
  name: "Jing Hui PANG",
  name_cn: "彭竞辉",
  title: "Full-Stack Software Engineer in Singapore",
  location: "Singapore",
  contact: {
    phone: "+65 81287402",
  ...
  work_history: [
    ...
    },
    {
      ...
      responsibilities: [
        "Engineered robust web and <b>mobile applications</b> in a <b>Docker-optimised setting</b>, resulting in a measurable improvement in system efficiency and contributing to client retention for recurring contracts",
        "Actively <b>collaborated with teammates on a Flutter-based mobile application</b> and shared responsibilities in both mobile development and backend API integration, collectively exceeding client expectations",
        "Authored, executed, and rigorously tested <b>UAT protocols and API test cases</b>, effectively serving as the quality assurance agent to confirm alignment with client specifications and maintain high product quality",
