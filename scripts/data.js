const RESUME_DATA = {
  ...
  // "summary": "I am a dedicated Software Engineer with over four years of hands-on experience in building scalable, high-performance systems and delivering innovative, customer-facing applications. My career spans full-stack development and infrastructure automation, where I have consistently applied best practices in coding and design patterns to drive operational excellence. At ByteDance, I have contributed to internal projects using an aPaaS platform with Node.js and Go—supporting over 180,000 users—while streamlining workflows and reducing costs through automation and agile methodologies. I excel at collaborating with cross-functional teams to translate complex requirements into scalable, high-impact solutions and have a strong foundation in continuous integration, test automation, and cloud technologies. Eager to expand my expertise in enterprise Java technologies, CI/CD, and container orchestration, I am excited about the opportunity to contribute to Equinix’s next-generation interconnection and SDN-based platform. My proactive learning mindset, commitment to innovation, and ability to adapt quickly make me a strong fit for roles in both software engineering and SRE.",
  // "summary": "I am a dedicated Software Engineer with over four years of hands-on experience in developing scalable, high-performance web applications. My background in full-stack development—leveraging JavaScript, Node.js, and modern frontend technologies—has enabled me to deliver user-centric solutions in fast-paced, agile environments. At ByteDance, I contributed to transformative projects through innovative low-code solutions, supporting over 180,000 users while streamlining operational processes. Passionate about continuous learning and driven by a proactive mindset, I am eager to apply my expertise in building intuitive, responsive interfaces to help Flo Energy make renewable energy more accessible and affordable.",
  // "summary": "I am a dedicated Software Engineer with over four years of hands-on experience in developing scalable, high-performance web applications. My background in full-stack development—leveraging JavaScript, Node.js, and modern frontend technologies—has enabled me to deliver user-centric solutions in fast-paced, agile environments. At ByteDance, I contributed to transformative projects through innovative low-code solutions, supporting over 180,000 users while streamlining operational processes. Passionate about continuous learning and driven by a proactive mindset, I am eager to apply my expertise in building intuitive, responsive interfaces to help Flo Energy make renewable energy more accessible and affordable.",
  // "summary": "I am a dedicated Software Engineer with over four years of hands-on experience in developing scalable, high-performance systems. My expertise spans full-stack development, utilizing technologies such as JavaScript, Node.js, Go, and Elixir. At ByteDance, I contributed to innovative internal projects through low-code platforms, enhancing operational efficiency and supporting over 180,000 users. My role involved close collaboration with cross-functional teams to translate complex requirements into effective solutions. Committed to continuous learning, I have completed ML-related coursework at MIT IDSS and am set to commence studies in Business Information Technology at NUS in August 2025. I am eager to apply my skills and passion for innovation to contribute to Apple's mission of delivering cutting-edge financial platforms.",
  // "summary": "A dedicated Full-Stack Software Engineer with over four years of experience in delivering high-performance, scalable software solutions, I have honed my expertise in agile project execution, infrastructure automation, and full-stack development using JavaScript, Go, and Elixir. At ByteDance, I played a pivotal role in developing robust internal platforms for large user bases, while my tenure at Pixium Digital as a Tech Lead saw me optimise system performance and drive significant improvements in deployment efficiencies. My proven ability to gather requirements effectively, communicate with stakeholders, and swiftly adapt to emerging technologies positions me as an ideal candidate for the Software Engineer II role at Microsoft.",
  // "summary": "A dedicated Full-Stack Software Engineer with over four years of experience in developing and maintaining high-performance, scalable platforms, I bring a robust background in infrastructure automation, agile methodologies, and full-stack development using JavaScript, Go, and Elixir. My tenure at ByteDance involved delivering large-scale internal platforms serving over 180,000 users, while my role as Tech Lead at Pixium Digital honed my ability to optimise system performance and streamline deployments. I am adept at collaborating with diverse teams, gathering requirements, and integrating cutting-edge technologies to enhance operational efficiency—qualities that align perfectly with the Senior Software Engineer – Platform Engineering SRE role at Equinix.",
  ...
  "work_history": [
    ...
    },
    {
      ...
      "responsibilities": [
        ...
        "Deployed and managed scalable WordPress sites leveraging Docker for modular infrastructure benefits",
        "Acquired and honed project management skills, adapting to agile methodologies and client interactions"
      ]
    }
  ],
  ...
  "volunteering": [
    {
      "title": "International Outreach Team - Armageddon 2019",
      "organization": "Beatnation",
      "start_date": "May 2019",
      "end_date": "June 2019",
