const RESUME_DATA = {
  ...
  // "summary": "As a passionate full-stack software engineer with over four years of experience delivering secure, scalable, and production-grade systems in high-stakes environments, I’m excited by the opportunity to contribute to JPMorgan Chase’s Post Trade Technology team. My technical foundation—developed at ByteDance and Pixium Digital—spans backend development using Java and Go, infrastructure automation with Terraform and AWS CDK, and modern application architecture built on Spring Boot and RESTful APIs. I bring a deep understanding of system design, test-driven development, and agile SDLC practices, coupled with real-world experience deploying resilient cloud-native applications. I’ve led cross-functional delivery efforts, owned critical backend components, and improved operational stability through continuous integration and observability practices. With a strong focus on code quality, automation, and security, I am eager to build robust solutions that support the complexity and scale of JPMorgan’s global post-trade systems, while growing within a team that champions technical excellence and innovation.",
