const RESUME_DATA = {
  ...
  // 20250502
  "summary": "I'm a software engineer who took the unconventional path—diving straight from a diploma into real-world engineering, quickly rising from intern to leader, and now crafting solutions for over <b>180,000 users at ByteDance</b>. With a relentless passion for technology and innovation, I've spent the past four years building impactful, scalable systems using <b>JavaScript, Elixir, PHP, Python, Go, and AWS</b>. At Pixium Digital, I didn't just write code; I elevated user experiences, boosted critical dashboard performance by 62.5%, and automated deployments so efficiently (Terraform & Docker) that initialisation times dropped by 80%. Currently, at ByteDance, I'm architecting large-scale internal aPaaS solutions—using Redis caching and distributed architectures—to significantly lower costs and streamline operations at roughly a third of traditional expenses. I'm committed to never standing still—certified in <b>Machine Learning from MIT-IDSS</b> and gearing up for my <b>part-time BIT at NUS</b>. My journey reflects a continuous upward trajectory driven by curiosity, resilience, and an unwavering commitment to excellence. I thrive in agile, cross-functional teams, and I'm excited to bring my blend of software engineering, infrastructure automation, DevOps, and innovative problem-solving skills to drive operational excellence and create meaningful, lasting impacts wherever I go.",
